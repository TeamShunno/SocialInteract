...
public class ParkImageActivity extends AppCompatActivity {
    ...
    private static final Integer[] IMAGES= {R.drawable.park_card,R.drawable.park_card,R.drawable.park_card,R.drawable.park_card};
    ...
    private void init() {
        ...
        mPager.setAdapter(new SlideImageAdapter(ParkImageActivity.this,ImagesArray));
